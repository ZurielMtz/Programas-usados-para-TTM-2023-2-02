...
if __name__ == '__main__':
    ...
    while(True):
        ...
        # ========= MOVING THE MOTOR ======================
        speed_reference =  -28# Velocidad
        # To roll up the cable --> Positive reference --> Moves the car up
        # To unroll the cable --> Negative reference --> Moves the car down
    
        motorArnes.moveMotorVel(speed_reference, velMAR, Tm)
        
        print(f'Ref: {speed_reference}  --- Vel Arnes {velMAR}')
        time.sleep_ms(50)        
